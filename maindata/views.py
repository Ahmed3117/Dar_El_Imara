...
def showfullreport(request):
    projects = Project.objects.all()
    context = {
        'projects': projects, 
    }
    return render(request,'maindata/fullreport.html',context)

def fullreport(request):
    print("dddddddddddddddddddddddddddddddddddddd")
    print(request.POST.get("searchedproject"))
    print("dddddddddddddddddddddddddddddddddddddd")
    projects = Project.objects.all()
    pk = request.POST.get("searchedproject")
    obj = ''
    project_expected_costs_list = []
    totaldesignworkscosts = 0
    totalengsupervisionworkscosts = 0
